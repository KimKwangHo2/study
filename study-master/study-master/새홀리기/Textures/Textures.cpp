...
HRESULT InitGeometry()
{
    ...
    if( FAILED( D3DXCreateTextureFromFile( g_pd3dDevice, L"banana2.PNG", &g_pTexture ) ) )
    {
	...
	D3DXCreateTextureFromFile(g_pd3dDevice, L"banana1.JPG", &g_pTexture1);
	D3DXCreateTextureFromFile(g_pd3dDevice, L"..\\banana1.JPG", &g_pTexture1);
    ...
    if( FAILED( g_pVB->Lock( 0, 0, ( void** )&pVertices, 0 ) ) )
        ...
        pVertices[0].position = D3DXVECTOR3( -2, -3, 0 );
        pVertices[0].color = 0xffffffff;
        pVertices[0].tu = 0.0f;
        pVertices[0].tv = 0.0f;

		pVertices[1].position = D3DXVECTOR3(1, -3, 0);
		pVertices[1].color = 0xffffffff;
		pVertices[1].tu = 1.0f;
		pVertices[1].tv = 0.0f;

		pVertices[2].position = D3DXVECTOR3(1, 0, 0);
		pVertices[2].color = 0xffffffff;
		pVertices[2].tu = 1.0f;
		pVertices[2].tv = 1.0f;
				  
		pVertices[3].position = D3DXVECTOR3(-2, -3, 0);
		pVertices[3].color = 0xffffffff;
		pVertices[3].tu = 1.0f;
		pVertices[3].tv = 1.0f;

		pVertices[4].position = D3DXVECTOR3(-2, 0, 0);
		pVertices[4].color = 0xffffffff;
		pVertices[4].tu = 1.0f;
		pVertices[4].tv = 0.0f;

		pVertices[5].position = D3DXVECTOR3(1, 0, 0);
